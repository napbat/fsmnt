...
Microsoft Interface Definition Language for the EFSRPC interface.
...
This IDL does not include a pointer_default declaration. As noted in [MS-RPCE], this declaration is
not required in MIDL, and, in this case, pointer_default(unique) is assumed.
